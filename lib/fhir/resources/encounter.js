  ...
  return {
    ...
    searchFilters: (ctx, callback) => {
      ...
      const supportedParams = {
        ...
        practitioner: { allowArray: false, required: false },
        'practitioner.organization': { allowArray: false, required: false },
        participant: { allowArray: false, required: false },
        location: { allowArray: false, required: false },
