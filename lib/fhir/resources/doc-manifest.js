...
module.exports = (mongo) => {
  ...
  return {
    ...
    searchFilters: (queryParams, callback) => {
      ...
      if (queryParams['type']) {
        query['$and'].push(fhirCommon.util.tokenToSystemValueElemMatch('type', queryParams['type']))
      }

      if (queryParams['status']) {
        query['$and'].push(fhirCommon.util.tokenToSystemValueElemMatch('status', queryParams['type']))
      }
