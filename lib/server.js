...
const buildCoreOutcomeHandler = (req, res, next) => {
  return (err, outcome) => {
    if (err) {
      return next(err)
    }
...
app.get('/fhir/:resourceType', (req, res, next) => {
  fhirCore.search(res.locals.ctx, req.params.resourceType, buildCoreOutcomeHandler(req, res, next))
})
app.get('/fhir/:resourceType/:id', (req, res, next) => {
  fhirCore.read(res.locals.ctx, req.params.resourceType, req.params.id, buildCoreOutcomeHandler(req, res, next))
})
app.get('/fhir/:resourceType/:id/_history/:vid', (req, res, next) => {
  fhirCore.vread(res.locals.ctx, req.params.resourceType, req.params.id, req.params.vid, buildCoreOutcomeHandler(req, res, next))
})
app.post('/fhir/:resourceType', (req, res, next) => {
  fhirCore.create(res.locals.ctx, req.params.resourceType, req.body, buildCoreOutcomeHandler(req, res, next))
})
app.put('/fhir/:resourceType/:id', (req, res, next) => {
  fhirCore.update(res.locals.ctx, req.params.resourceType, req.params.id, req.body, buildCoreOutcomeHandler(req, res, next))
})
