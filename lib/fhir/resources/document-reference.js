  ...
  return {
    ...
    searchFilters: (ctx, callback) => {
      ...
      const supportedParams = {
        ...
        'patient.identifier': { allowArray: true, required: false },
        indexed: { allowArray: true, required: false },
        'author.given': { allowArray: true, required: false },
        'author.family': { allowArray: true, required: false },
        status: { allowArray: true, required: false },
        class: { allowArray: true, required: false },
        type: { allowArray: true, required: false },
        setting: { allowArray: true, required: false },
        period: { allowArray: true, required: false },
        facility: { allowArray: true, required: false },
        event: { allowArray: true, required: false },
        securityLabel: { allowArray: true, required: false },
        format: { allowArray: true, required: false },
        'related-id': { allowArray: true, required: false }
      }
