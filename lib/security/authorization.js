        ...
        if (interaction === 'search') {
          if (interactionType.searchFilters) {
            interactionType.searchFilters(ctx.authenticatedUser, (err, searchFilters) => {
              ...
              callback(null, null, null, resourceType, postInteractionHandler, searchFilters)
            })
          } else {
            callback(null, null, null, resourceType, postInteractionHandler, null, interactionType.searchAllAllowed)
          }
        } else {
          callback(null, null, null, resourceType, postInteractionHandler)
        }
      }
