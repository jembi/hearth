...
exports.buildmCSDAuditMsg = (ctx, transaction, actor) => {
  ...
  // Active Participant - System
  var sysRoleCode = new ATNA.construct.Code(110153, 'Source', 'DCM')
  var sysParticipant = new ATNA.construct.ActiveParticipant(ctx.authenticatedUser.email, '', false, ctx.requestorIp, ATNA.constants.NET_AP_TYPE_IP, [sysRoleCode])

  // Active Participant - User
  var userRoleCodeDef = new ATNA.construct.Code(110152, 'DCM', 'Destination')
  var userParticipant = new ATNA.construct.ActiveParticipant(ctx.authenticatedUser.email, '', true, null, null, [userRoleCodeDef])
