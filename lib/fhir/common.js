...
module.exports = (mongo) => {
  ...
  let formatBundleResources = (searchResource) => {
    searchResource.entry.forEach((resource) => {
      resource.resource = formatResource(resource.resource)
    })
  ...
  return {
    ...
    formatBundleResources: formatBundleResources,
