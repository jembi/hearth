...
module.exports = (mongo) => {
  ...
  return {
    ...
    util: {
      ...
      validateQueryParamsReturnQueryObject: (queryParams, supported, callback) => {
        ...
        for (const key in queryParams) {
          ...
          if (keyOperator && !supported[keyActual].operators[keyOperator]) {
            return callback(`This endpoint has the following query parameter which does not allow for the ':${keyOperator}' operator`, null)
          }
          ...
          queryObject[keyActual] = {
            ...
            exact: supported[keyActual].operators['exact']
          }
        }
