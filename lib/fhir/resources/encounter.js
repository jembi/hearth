  ...
  return {
    ...
    searchFilters: (ctx, callback) => {
      ...
      const supportedParams = {
        ...
        practitioner: { allowArray: true, required: false },
        'practitioner.organization': { allowArray: true, required: false },
        participant: { allowArray: true, required: false },
        location: { allowArray: true, required: false },
