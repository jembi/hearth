  ...
  return {
    buildPIXmQuery: (ctx, callback) => {
      ...
      const supportedParams = {
        ...
        targetSystem: { allowArray: true, operators: { exact: true } }
      }

      fhirCommon.util.validateAndModifyQueryParams(queryParams, supportedParams, (badRequest, queryObject) => {
        badRequest = badRequest || fhirCommon.util.validateFullSourceIdentifierToken(queryObject['sourceIdentifier']['default'])
        ...
        const identifier = queryObject['sourceIdentifier']['default']
