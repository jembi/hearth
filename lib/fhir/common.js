...
module.exports = (mongo) => {
  ...
  return {
    ...
    util: {
      ...
      /**
       * Build a mongo query clause that allows for date searching.
       *
       * Multiple date params will be handle, e.g. field=geFROM&field=leTO
       *
       * @param {String} field The FHIR field that will be matched
       ...
       */
      paramAsDateRangeClause: (field, params) => {
