...
module.exports = (mongo) => {
  ...
  const addLinkToMatchAndUpdate = (match, resource, linkType) => {
    return new Promise((resolve, reject) => {
      ...
      const update = addLinkToResource(match, matchLink, linkType, match._mpi.search.score)
      updateResource(update, createPromiseErrHandlerForCallback(resolve, reject))
    })
  }
