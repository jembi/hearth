      ...
      queryUtils.validateAndParseQueryParams(queryParams, supportedParams, (badRequest, queryObject) => {
        ...
        if (queryObject['practitioner.identifier']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['practitioner.identifier'][constants.NO_MODIFER], 'practitioner.reference', 'identifier', practitioner, (err, clause) => {
        ...
        if (queryObject['practitioner.name']) {
          for (const modifier in queryObject['practitioner.name'] ) {
            promises.push(new Promise((resolve, reject) => {
              queryUtils.genChainedParamQuery(ctx, queryObject['practitioner.name'][modifier], 'practitioner.reference', 'name:'+modifier, practitioner, (err, clause) => {
                if (err) { return reject(err) }
                query['$and'].push(clause)
                resolve()
              })
        ...
        if (queryObject['practitioner.family']) {
          for (const modifier in queryObject['practitioner.family'] ) {
            promises.push(new Promise((resolve, reject) => {
              queryUtils.genChainedParamQuery(ctx, queryObject['practitioner.family'][modifier], 'practitioner.reference', 'family:'+modifier, practitioner, (err, clause) => {
                if (err) { return reject(err) }
                query['$and'].push(clause)
                resolve()
              })
        ...
        if (queryObject['practitioner.given']) {
          for (const modifier in queryObject['practitioner.given'] ) {
            promises.push(new Promise((resolve, reject) => {
              queryUtils.genChainedParamQuery(ctx, queryObject['practitioner.given'][modifier], 'practitioner.reference', 'given:'+modifier, practitioner, (err, clause) => {
                if (err) { return reject(err) }
                query['$and'].push(clause)
                resolve()
              })
        ...
        if (queryObject['practitioner.address']) {
          for (const modifier in queryObject['practitioner.address'] ) {
            promises.push(new Promise((resolve, reject) => {
              queryUtils.genChainedParamQuery(ctx, queryObject['practitioner.address'][modifier], 'practitioner.reference', 'address:'+modifier, practitioner, (err, clause) => {
                if (err) { return reject(err) }
                query['$and'].push(clause)
                resolve()
              })
        ...
        if (queryObject['practitioner.address-state']) {
          for (const modifier in queryObject['practitioner.address-state'] ) {
            promises.push(new Promise((resolve, reject) => {
              queryUtils.genChainedParamQuery(ctx, queryObject['practitioner.address-state'][modifier], 'practitioner.reference', 'address-state:'+modifier, practitioner, (err, clause) => {
                if (err) { return reject(err) }
                query['$and'].push(clause)
                resolve()
              })
        ...
        if (queryObject['practitioner.communication']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['practitioner.communication'][constants.NO_MODIFER], 'practitioner.reference', 'communication', practitioner, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['organization.active']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['organization.active'][constants.NO_MODIFER], 'organization.reference', 'active', organization, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['organization.identifier']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['organization.identifier'][constants.NO_MODIFER], 'organization.reference', 'identifier', organization, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['organization.name']) {
          for (const modifier in queryObject['organization.name'] ) {
            promises.push(new Promise((resolve, reject) => {
              queryUtils.genChainedParamQuery(ctx, queryObject['organization.name'][modifier], 'organization.reference', 'name:'+modifier, organization, (err, clause) => {
                if (err) { return reject(err) }
                query['$and'].push(clause)
                resolve()
              })
        ...
        if (queryObject['location.status']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['location.status'][constants.NO_MODIFER], 'location.reference', 'status', location, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['location.identifier']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['location.identifier'][constants.NO_MODIFER], 'location.reference', 'identifier', location, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['location.name']) {
          for (const modifier in queryObject['location.name'] ) {
            promises.push(new Promise((resolve, reject) => {
              queryUtils.genChainedParamQuery(ctx, queryObject['location.name'][modifier], 'location.reference', 'name:'+modifier, location, (err, clause) => {
                if (err) { return reject(err) }
                query['$and'].push(clause)
                resolve()
              })
        ...
        if (queryObject['service.active']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['service.active'][constants.NO_MODIFER], 'healthcareService.reference', 'active', healthcareService, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['service.identifier']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['service.identifier'][constants.NO_MODIFER], 'healthcareService.reference', 'identifier', healthcareService, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['service.type']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['service.type'][constants.NO_MODIFER], 'healthcareService.reference', 'type', healthcareService, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['service.location']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['service.location'][constants.NO_MODIFER], 'healthcareService.reference', 'location', healthcareService, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
        ...
        if (queryObject['service.name']) {
          for (const modifier in queryObject['service.name'] ) {
            promises.push(new Promise((resolve, reject) => {
              queryUtils.genChainedParamQuery(ctx, queryObject['service.name'][modifier], 'healthcareService.reference', 'name:'+modifier, healthcareService, (err, clause) => {
                if (err) { return reject(err) }
                query['$and'].push(clause)
                resolve()
              })
        ...
        if (queryObject['service.organization']) {
          promises.push(new Promise((resolve, reject) => {
            queryUtils.genChainedParamQuery(ctx, queryObject['service.organization'][constants.NO_MODIFER], 'healthcareService.reference', 'organization', healthcareService, (err, clause) => {
              if (err) { return reject(err) }
              query['$and'].push(clause)
              resolve()
            })
