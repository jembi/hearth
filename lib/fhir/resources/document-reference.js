  ...
  return {
    ...
    searchFilters: (ctx, callback) => {
      ...
      const supportedParams = {
        patient: { allowArray: true, required: false, operators: { exact: true } },
        'patient.identifier': { allowArray: false, required: false, operators: { exact: true } },
        indexed: { allowArray: true, required: false, operators: { exact: true } },
        'author.given': { allowArray: false, required: false, operators: { exact: true } },
        'author.family': { allowArray: false, required: false, operators: { exact: true } },
        status: { allowArray: false, required: false, operators: { exact: true } },
        class: { allowArray: false, required: false, operators: { exact: true } },
        type: { allowArray: false, required: false, operators: { exact: true } },
        setting: { allowArray: false, required: false, operators: { exact: true } },
        period: { allowArray: true, required: false, operators: { exact: true } },
        facility: { allowArray: false, required: false, operators: { exact: true } },
        event: { allowArray: false, required: false, operators: { exact: true } },
        securityLabel: { allowArray: false, required: false, operators: { exact: true } },
        format: { allowArray: false, required: false, operators: { exact: true } },
        'related-id': { allowArray: false, required: false, operators: { exact: true } }
      }
