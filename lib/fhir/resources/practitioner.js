  ...
  return {
    ...
    searchFilters: (ctx, callback) => {
      ...
      const supportedParams = {
        identifier: { allowArray: true, required: false },
        given: { allowArray: true, required: false },
        family: { allowArray: true, required: false },
        role: { allowArray: true, required: false },
        organization: { allowArray: true, required: false }
      }
