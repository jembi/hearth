  ...
  return {
    ...
    searchFilters: (ctx, callback) => {
      ...
      const supportedParams = {
        ...
        created: { allowArray: false, required: false, operators: { exact: true } },
      ...
      fhirCommon.util.validateAndModifyQueryParams(queryParams, supportedParams, (badRequest, queryObject) => {
        ...
        if (queryObject['created']) {
          query['$and'].push(fhirCommon.util.paramAsDateRangeClause('_transforms.created', queryObject['created'].value))
        }
        ...
        if (queryObject['status']) {
          query['$and'].push({ status: queryObject['status'].value })
        }
