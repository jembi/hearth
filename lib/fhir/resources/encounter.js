  ...
  return {
    ...
    searchFilters: (ctx, callback) => {
      ...
      const supportedParams = {
        ...
        practitioner: { allowArray: false, required: false, operators: { exact: true } },
        'practitioner.organization': { allowArray: false, required: false, operators: { exact: true } },
        participant: { allowArray: false, required: false, operators: { exact: true } },
        location: { allowArray: false, required: false, operators: { exact: true } },
