    ...
    resources.forEach((resource) => {
      if (resource.search.extension.valueCode === 'certain') {
        promises.push(new Promise((resolve, reject) => {
          linkResource(resource.resource, referenceLink, constants.LINK_TYPE_REPLACES, resource.search.score, createPromiseHandlerFunc(resolve, reject))
        }))
      }
      if (resource.search.extension.valueCode === 'probable') {
        promises.push(new Promise((resolve, reject) => {
          linkResource(resource.resource, referenceLink, constants.LINK_TYPE_DUPLICATE, resource.search.score, createPromiseHandlerFunc(resolve, reject))
        }))
      }
    })
